...
export abstract class clientsRepository {
    ...
    abstract findUniqueTransaction(id: string): Promise<TransactionEntity>
    abstract update(id: string, dataClient: UpdateClientDto): Promise<UpdateClientDto>
    abstract updateTransaction(id: string, dataTransaction: UpdateTransactionDto): Promise<UpdateTransactionDto>
